export default async function handler(req, res) {
  ...
  // ── 행별 핵심 피드백 포인트 ──────────────────────────────────────
  const charGuides = {
    'あ': "あ는 가로획 위로 중심이 지나가는지 확인. あ vs お 혼동 주의: お는 오른쪽 위에 점이 있음.",
    'い': "두 획의 길이 차이가 자연스러운지, 오른쪽 획이 살짝 짧고 안쪽으로 굽었는지 확인.",
    'う': "첫 번째 점과 아래 곡선의 위치가 수직으로 맞는지 체크. 점의 위치가 너무 치우치지 않게.",
    'え': "아래 가로획이 중심을 지나 좌우로 균형 있게 뻗었는지 확인.",
    'お': "오른쪽 위 점의 위치 확인. あ와 혼동하지 않도록 점의 유무가 핵심.",
